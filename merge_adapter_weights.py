...
# python merge_adapter_weights.py --peft_model_id runs/meta-llama/Llama-3.2-1B-math-orca-qlora-10k-ep1 --repository_id Llama-3.2-1B-math-orca-qlora-10k-ep1-merged
